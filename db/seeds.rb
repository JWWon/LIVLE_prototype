...
stages = Stage.create([
                          ...
                          {title: '팔레트', artist: '아이유', user_id: user, youtube_id: 'nyLoEv1ToX0', count_like: int_nil, count_view: int_nil, count_share: int_nil},
...
upcomings = Upcoming.create([
                                ...
                                {title: '전주얼티밋뮤직페스티벌', artist: '볼빨간사춘기', youtube_id: '8lsSkgxXGOA', d_day: '2017.08.04', place: rplace, ticket_link: 'http://ticket.melon.com/performance/index.htm?prodId=200614'},
